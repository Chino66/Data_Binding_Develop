    ...
    public class PropertyAccessorDetourExample : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            foreach (var propertyInfo in properties)
            {
                ...
                var newmd =
                    (Action<TestData, string>) newDynamicMethod.CreateDelegate(typeof(Action<TestData, string>));
        ...
        public static Dictionary<string /*property name*/, string /*value*/>
            Test3Dic = new Dictionary<string, string>();
